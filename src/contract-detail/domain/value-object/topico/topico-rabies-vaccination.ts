import { RabiesVaccinationContractInterface } from '../../interfaces/topico.interface';
...
export class TopicoRabiesVaccination {
  constructor(
  ...
  toJson(): RabiesVaccinationContractInterface {
    return {
