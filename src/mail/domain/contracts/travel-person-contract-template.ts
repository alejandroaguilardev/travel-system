                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 20px 50px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #002060;">
                            ...
                            <p align="center" style="margin-top: 20px;">
                                <a href="https://www.app.pettravelperu.com/viaje/{{contractId}}/{{contractDetailId}}/{{token}}" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 10px 30px; background-color: #1a82e2; color: #fff; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 14px; transition: background-color 0.3s;">
