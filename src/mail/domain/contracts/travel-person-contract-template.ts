    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 20px 50px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #002060;">
                            <h1  style="font-size: 22px;">
                                <p style="margin-top: 20px;">Por favor, complete los detalles de la persona que acompañará a {{pet.name}} durante el viaje, (si es por cargo serán los datos  de la persona responsable de los documentos).
                                </p>
                            </h1>
                                                        
                            <p style="margin-top: 20px;">Por favor, complete los detalles de la persona que acompañará a {{pet.name}} durante el viaje.
                            </p>
                            <p align="center" style="margin-top: 20px;">
                                <a href="https://travel-system-client.vercel.app/viaje/{{contractId}}/{{contractDetailId}}/{{token}}" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 10px 30px; background-color: #1a82e2; color: #fff; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 14px; transition: background-color 0.3s;">
        ...
        <tr>
            <td align="center" >
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 0 50px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; ">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff" style="padding: 20px 40px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px;">
                            <hr />
                            <p>Ha recibido este correo electrónico porque se necesita indicar que persona viajará junto a la mascota</p>
