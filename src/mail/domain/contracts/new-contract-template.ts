                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 20px 50px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #002060;">
                            ...
                            <p align="center" style="margin-top: 20px;">
                                <a href="https://travel-system-client.vercel.app/" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 10px 30px; background-color: #1a82e2; color: #fff; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 14px; transition: background-color 0.3s;">
                                    Recuerda dar seguimiento a los requisitos establecidos
                                </a>
                            </p>
                        </td>
                    </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff" style="padding: 20px 40px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px;">
                            <hr />
                            <p>Ha recibido este correo electrónico porque recientemente ha sido registrado en la plataforma de viajes para mascotas.</p>
