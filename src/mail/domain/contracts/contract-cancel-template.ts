...
<head>
    ...
    <title> Notificación de Cancelación de Contrato en Pet Travel</title>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin-bottom: 5px;">Lamentamos informarte que el contrato en Pet Travel ha sido
                                cancelado.  {{reasonForCancellation}} </p>
                               
                                <p style="margin-bottom: 5px;">Queremos asegurarte que estamos aquí para ayudarte en este proceso y para
                                responder cualquier pregunta que puedas tener.</p>

                            <p style="margin-bottom: 5px;">Entendemos que la cancelación del contrato puede generar
                                algunas preguntas o inquietudes, por lo que te animamos a ponerte en contacto con
                                nuestro equipo de soporte para obtener más información o asistencia.</p>

                            <p style="margin-bottom: 5px;">Apreciamos tu comprensión y paciencia en este asunto. Si hay
                                algo en lo que podamos ayudarte o si necesitas aclaraciones adicionales, no dudes en
                                hacérnoslo saber.</p>
                            <p style="margin-bottom: 5px;">Gracias por tu confianza en Pet Travel. Esperamos poder
                                servirte mejor en el futuro. </p>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff"
                            ...
                            <hr />
                            <p>Ha recibido este correo electrónico porque recientemente ha sido registrado en la
                                plataforma de viajes para mascotas.</p>
