...
<head>
    ...
    <title>Pet Travel Contrato Inspección Senasa {{pet.name}}</title>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin-top: 20px;">Queremos informarle que hemos programado la fecha de inspección
                                para su mascota. La fecha acordada es: {{date}}.</p>

                            <p style="margin-top: 20px;"> Por favor, asegúrese de preparar a su mascota de acuerdo con
                                las indicaciones previamente proporcionadas.</p>

                            <ul>
                                <li>

                                    Antes de llevar a tu mascota a SENASA, asegúrate de que esté limpia y bien cuidada.
                                    Esto
                                    incluye el baño, el cepillado y la eliminación de parásitos externos, si es
                                    necesario.
                                </li>
                            </ul>
