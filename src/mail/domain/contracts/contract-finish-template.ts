...
<head>
    ...
    <title> Notificación de Finalización de Contrato en Pet Travel</title>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin-bottom: 5px;">Nos complace informarte que el contrato ha finalizado con
                                éxito
                                en Pet Travel. Queremos agradecerte por tu colaboración y compromiso durante el período
                                de vigencia del contrato.</p>

                            <p style="margin-bottom: 5px;">Ahora que el contrato ha concluido, te animamos a que revises
                                cualquier detalle pendiente y a que te asegures de haber cumplido con todos los
                                requisitos establecidos.</p>

                            <p style="margin-bottom: 5px;">Si tienes alguna pregunta o necesitas asistencia adicional,
                                no
                                dudes en ponerte en contacto con nuestro equipo de soporte. Estamos aquí para ayudarte
                                en todo lo que necesites.</p>
                            <p style="margin-bottom: 5px;">Gracias nuevamente por confiar en Pet Travel. ¡Esperamos
                                seguir siendo tu socio de confianza en el futuro!.</p>
                        </td>
                    </tr>
                </table>
            </td>
